...
/**
 * Created by l2ol3otic2 on 4/17/2015.
 */

public class Set_1Map_Maprender extends FragmentActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.set1maplayout);
        ...
        buttonAnimate.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                gd.animateDirection(mMap, gd.getDirection(mDoc), GoogleDirection.SPEED_VERY_SLOW
                        ...
                        , new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.drawable.tri))
                        , true, false, null);
            }
        });
    }
